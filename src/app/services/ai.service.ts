...
2. Synonyms (2-3 words, format each as "english (ภาษาไทย)"): <synonym1>, <synonym2>, ...
3. Antonyms (1-2 words, format each as "english (ภาษาไทย)", or "none" if not applicable): <antonym1>, ...
